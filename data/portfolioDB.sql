...
insert into Person(personCode, addressId, firstName, lastName) values ('7AB', (Select a.addressId from Address a left join City c on a.cityId = c.cityId where a.street = '83791 Fairfield Hill'), 'Vincents', 'Meech');
...
insert into Asset(assetCode, label, apr) values ('1BB', '1-year CD', 0.024);
insert into Asset(assetCode, label, quarterlyDividend, baseRateReturn, betaMeasure, stockSymbol, sharePrice) values('2BB', 'Fitbit', 0.00, 0.072, -0.21, 'FIT', 6.30);
insert into Asset(assetCode, label, quarterlyDividend, baseRateReturn, baseOmegaMeasure, totalValue) values('3BB', 'Rental Property 1', 10300, 0.125, 0.4, 130500);
insert into Asset(assetCode, label, apr) values ('4BB', 'IRA', 0.034);
insert into Asset(assetCode, label, apr) values ('5BB', '5-year CD', 0.054);
insert into Asset(assetCode, label, apr) values ('6BB', 'Money Market Savings', 0.043);
insert into Asset(assetCode, label, quarterlyDividend, baseRateReturn, betaMeasure, stockSymbol, sharePrice) values('7BB', 'Plug Power', 0.00, 0.042, 0.44, 'PLUG', 4.25);
insert into Asset(assetCode, label, apr) values ('8BB', '10-year CD', 0.104);
insert into Asset(assetCode, label, quarterlyDividend, baseRateReturn, betaMeasure, stockSymbol, sharePrice) values('9BB', 'Altice USA', 0.0324, 0.23, 0.08, 'ATUS', 25.81);
insert into Asset(assetCode, label, apr) values ('10BB', 'Savings Account', 0.055);
insert into Asset(assetCode, label, apr) values ('11BB', 'Savings Account', 0.039);
insert into Asset(assetCode, label, quarterlyDividend, baseRateReturn, baseOmegaMeasure, totalValue) values('12BB', 'Rental Property 2', 15000, 0.105, 0.4, 1300000);
insert into Asset(assetCode, label, quarterlyDividend, baseRateReturn, baseOmegaMeasure, totalValue) values('13BB', 'Rental Property 3', 20300, 0.405, 0.4, 155000);
insert into Asset(assetCode, label, apr) values ('14BB', '5-year CD', 0.0435);
insert into Asset(assetCode, label, quarterlyDividend, baseRateReturn, betaMeasure, stockSymbol, sharePrice) values('15BB', 'Enterprise Products', 0.445, 0.0089, -0.03, 'EPD', 22.68);
insert into Asset(assetCode, label, apr) values ('16BB', '1-year CD', 0.0345);
...
insert into AssetPortfolio(portfolioId, assetValue, assetId) values ((select p.portfolioId from Portfolio p where p.portfolioCode = '2CB' and p.ownerCode = '4AB'), 0.124, (select a.assetId from Asset a where a.assetCode = '3BB'));
...
insert into AssetPortfolio(portfolioId, assetValue, assetId) values ((select p.portfolioId from Portfolio p where p.portfolioCode = '5CB' and p.ownerCode = '8AB'), 0.424, (select a.assetId from Asset a where a.assetCode = '12BB'));
...
insert into AssetPortfolio(portfolioId, assetValue, assetId) values ((select p.portfolioId from Portfolio p where p.portfolioCode = '6CB' and p.ownerCode = '9AB'), 0.0543, (select a.assetId from Asset a where a.assetCode = '13BB'));
